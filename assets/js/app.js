...
class ThemeLayout {
    ...
    initSwitchListener() {
        var n = this;
        document.querySelectorAll("input[name=data-sidebar-color]").forEach(function(t) {
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__TAPLOX_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".settings-bar input[type=radio]").forEach(function(e) {
            e.checked = !1
        });
